<template>
  ...
  <p class="info">I'm currently available to take on new projects, so feel free to send me a message about
    anything that you want to run past me. You can contact anytime at 24/7.</p>
  ...
  .contact-info {
    ...
    background-color: #222; /* Similar background color to .contact-form */
...
button:hover {
  ...
  /* box-shadow: 0 0 30px 5px  #ffbb0037; */
...
button::before {
  ...
  opacity: 0;
  background: #fff;
  box-shadow: 0 0 50px 30px #f86336;
